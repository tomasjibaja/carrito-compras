# Kint-A-Mart
An e-commerce in React consuming the DummyJSON API.
The user can filter products by price and category, add, remove and manage quantities in the cart and then proceed to checkout to confirm the order.
